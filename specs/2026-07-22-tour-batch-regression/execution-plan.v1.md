...
| P4 | Lock paid calls to the eight frozen request hashes. | Wrong, missing, duplicate, or ninth request fails before provider construction. |
...
| 6 | Seal inputs | Hash canonical manifest and every request. | Immutable experiment identity. | Recomputed hashes match. | Any edit invalidates prior output. |
